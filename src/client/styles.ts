...
export function installStyles(): () => void {
  ...
  style.textContent = `
    ...
    .dsh-trajectory-sensitive-notice{padding:8px 14px;border-bottom:1px solid rgba(251,191,36,.22);background:rgba(251,191,36,.07);color:#fbbf24;font-size:10.5px;line-height:1.5}
    .dsh-trajectory-detail-loading{margin-bottom:8px;color:var(--dsw-alias-label-caption,rgb(129,133,140));font-size:10.5px}.dsh-trajectory-detail-error{margin-bottom:8px;color:#f87171;font-size:10.5px}
